...
<div class="body-content">
        ...
        <div class="d-flex border-bottom-info flex-column bd-highlight mb-3 w-75">
            <div class="mb-auto p-2 bd-highlight">
                <div class="user-account d-flex mr-4">
                    ...
                    <a name="user_name" class="my-auto" href="#"></a>
                </div>
            </div>
            <div class="mb-5 p-3 bd-highlight">
                <p class="text-lg-left text-primary">[Chủ đề]:&nbsp;<a href="#" name="title">title</a></p>
                <p class="text-lg-left text-secondary">[Câu hỏi]:&nbsp;<span class="text-dark" name="content" >content</span></p>
                <p class="text-small text-secondary">Cập nhật lúc: </p>
            </div>
    ...
    <div class="row content mx-auto d-flex flex-column align-items-center">
        <form action="" method="get" class="wrap bg-white wrap-content shadow w-75">
            <p > Người trả lời: </p>
            <p > Nội dung: </p>
