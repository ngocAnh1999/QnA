...
<div class="body-content">
                ...
                <div class="mt-4 d-flex justify-content-between">
                    <div class="d-flex">
                        ...
                        @else 
                            ...
                            <a class="ml-4" href="{{ route('accept', $answer->id) }}">
        ...
        <div id="modalEdit" class="modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('editAnswer', $question->id) }}" method="post">
                        @csrf
                        <div id="edit-modal" class="modal-body d-flex flex-column">
                            <input class="d-none id" name="e_id" />
    ...
    <script src="{{ asset('js/qna/ans.js') }}"></script>
</div>
@endsection